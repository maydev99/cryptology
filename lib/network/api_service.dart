...
import 'package:layout/secret.dart';
...
class APiService {
  ...
  Future getCoinData(String coinList) async {
    var url = 'https://api.nomics.com/v1/currencies/ticker?key=${secret.accessKey}&ids=$coinList&interval=1d,7d,30d&per-page=100&page=1';
